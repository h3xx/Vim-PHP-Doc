...
if !exists("php_ignore_phpdoc")
    ...
    syntax match  phpDocTags  "@\(abstract\|access\|author\|category\|copyright\|deprecated\|example\|final\|global\|ignore\|internal\|license\|link\|method\|name\|package\|param\|property\|return\|see\|since\|static\|staticvar\|subpackage\|todo\|tutorial\|uses\|var\|version\)\s\+" containedin=phpComment nextgroup=phpDocParam
    syntax match  phpDocParam contained "\(.*>\|\S\+\)|\?" nextgroup=phpDocParam
